...
```bash
personal-blog-syndicator$ sam build --use-container
```
...
```bash
personal-blog-syndicator$ sam logs -n StockCheckerFunction --stack-name "personal-blog-syndicator" --tail
```
...
```bash
personal-blog-syndicator$ pip install -r tests/requirements.txt --user
# unit test
personal-blog-syndicator$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
personal-blog-syndicator$ AWS_SAM_STACK_NAME="personal-blog-syndicator" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "personal-blog-syndicator"
```
