...
# Run the SAM command
echo '{"url": "https://www.brettcooke.io/posts/obsidian-is-my-everything-app"}' | sam local invoke --debug --event - "LinkedInPosterFunction" --parameter-overrides $PARAM_OVERRIDES
