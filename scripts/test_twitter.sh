...
# Run the SAM command
echo '{"url": "https://www.brettcooke.io/posts/youre-not-as-good-as-you-think"}' | sam local invoke --event - "TwitterPosterFunction" --parameter-overrides $PARAM_OVERRIDES
